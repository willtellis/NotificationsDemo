...
extension AppDelegate {
    ...
    func registorForNotifications() {
        ...
        let plainCategory = UNNotificationCategory(identifier: NotificationType.plain.rawValue, actions: [actionWaddup], intentIdentifiers: [ActionType.waddup.rawValue], options: categoryOptions)
        let serviceExtensionCategory = UNNotificationCategory(identifier: NotificationType.serviceExtension.rawValue, actions: [actionWaddup], intentIdentifiers: [ActionType.waddup.rawValue], options: categoryOptions)
